...
// INICIO: Cargar productos desde la base de datos
$productos = [];
$sql_productos = "SELECT producto FROM productos";
...
// FIN: Cargar productos desde la base de datos
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $trans_nom = $_POST['trans_nom'] ?? null; // No obligatorio
    $trans_dir = $_POST['trans_dir'] ?? null; // No obligatorio
    $trans_tel = $_POST['trans_tel'] ?? null; // No obligatorio
    $trans_cuit = $_POST['trans_cuit'] ?? null; // No obligatorio
    $total = $_POST['total'];
    ...
    // Validar el formato del CUIT (solo si se proporciona)
    if (!empty($cli_cuit) && !preg_match('/^\d{11}$/', $cli_cuit)) {
    ...
    <div style='margin-top: 20px; padding-left: -20px;'> <!-- Ajustado el margen izquierdo -->
        <table style='width: 100%; border-collapse: collapse; border: 1px solid white; color: black; margin-left: -20px;'> <!-- Ajustado margen izquierdo de la tabla -->
            <tbody>";
    ...
    foreach ($_POST['detalle'] as $index => $detalle) {
        ...
        $html .= "
            <tr>
                <td style='width: 5%; text-align: left; padding-left: 30px; border: 1px solid white;'>$cantidad</td> <!-- Ajustado padding-left -->
                <td style='width: 56%; text-align: left; padding-left: 20px; border: 1px solid white;'>$detalle</td> <!-- Agregado padding-left para separar de $cantidad -->
        ...
        <form method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="cli_dir" name="cli_dir" autocomplete="off" aria-required="false">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
                    <label for="cli_loca" class="form-label">Localidad</label>
                    <input type="text" class="form-control" id="cli_loca" name="cli_loca" autocomplete="off" aria-required="false">
                </div>
                <div class="col">
                    <label for="cli_pcia" class="form-label">Provincia</label>
                    <input type="text" class="form-control" id="cli_pcia" name="cli_pcia" autocomplete="off" aria-required="false">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
                ...
                <div class="col">
                    ...
                    <input type="number" class="form-control" id="cli_cuit" name="cli_cuit" autocomplete="off" aria-required="false"> <!-- No obligatorio -->
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="trans_nom" name="trans_nom" autocomplete="off" aria-required="false"> <!-- No obligatorio -->
                </div>
                <div class="col">
                    <label for="trans_dir" class="form-label">Dirección</label>
                    <input type="text" class="form-control" id="trans_dir" name="trans_dir" autocomplete="off" aria-required="false"> <!-- No obligatorio -->
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
                    <label for="trans_tel" class="form-label">Teléfono</label>
                    <input type="number" class="form-control" id="trans_tel" name="trans_tel" autocomplete="off" aria-required="false"> <!-- No obligatorio -->
                </div>
                <div class="col">
                    <label for="trans_cuit" class="form-label">CUIT</label>
                    <input type="number" class="form-control" id="trans_cuit" name="trans_cuit" autocomplete="off" aria-required="false"> <!-- No obligatorio -->
                </div>
            </div>
            ...
            <div id="detalle-container">
                <div class="row mb-3">
                    ...
                    <div class="col-5">
                        <!-- INICIO: Campo detalle como select con productos -->
                        ...
                        <!-- FIN: Campo detalle como select con productos -->
                    </div>
                    <div class="col-2">
