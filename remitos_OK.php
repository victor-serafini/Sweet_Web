...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    <div style='margin-top: 20px; padding-left: 30px;'> <!-- Ajustar margen izquierdo para alinear la tabla -->
        <table border='1' style='width: 100%; border-collapse: collapse;'>
            <thead>
                <tr>
                    <th style='width: 9%;'>Cantidad</th> <!-- Reducir a 9% -->
                    <th style='width: 51%;'>Detalle</th> <!-- Incrementar a 51% -->
                    <th style='width: 20%; text-align: right;'>Costo</th> <!-- Alinear a la derecha -->
                    <th style='width: 20%; text-align: right;'>Costo Total</th> <!-- Alinear a la derecha -->
                </tr>
            </thead>
            <tbody>";
    ...
    foreach ($_POST['detalle'] as $index => $detalle) {
        ...
        $html .= "
            <tr>
                ...
                <td>$detalle</td>
                <td style='text-align: right;'>" . number_format($costo, 2) . "</td> <!-- Alinear a la derecha -->
                <td style='text-align: right;'>" . number_format($costo_total, 2) . "</td> <!-- Alinear a la derecha -->
            </tr>";
    }
